...
const recentNews = [
  {
    date: "Mar 2026",
    text: "Rebuilt my WebRTC side project HubStream integrated with SFU feature with Coding Agent's help.",
  },
  { date: "Dec 2025", text: "Graduated Master's in NLP at UC Santa Cruz." },
  { date: "Sep 2024", text: "Started Master's in NLP at UC Santa Cruz." },
  {
    date: "Sep 2024",
    text: "Finished my tenure as a Senior Software Engineer at ASUS.",
  },
];
...
const featuredProjects = [
  {
    title: "Yapper",
    desc: "An AI platform that turns any movie or video clip into a punchy funny-commentary track — a 12-stage resumable pipeline running ASR, multimodal LLM scripting, and voice-cloned TTS.",
    link: "https://yapper.yuchia.dev/",
  },
  {
    title: "HubStream",
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-16 md:-mt-24 relative z-10 w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-end gap-6 mb-12">
          ...
          <div className="pb-2">
            <h1 className="text-4xl md:text-5xl font-mono font-bold tracking-tight mb-2">
              Yuchia Chang
            </h1>
            <p className="text-xl text-primary font-mono mb-3">
              SWE | MLE | SRE | AI Engineer
            </p>
            <div className="flex flex-wrap items-center gap-4 text-muted-foreground">
              <span className="flex items-center gap-1 text-sm">
                <MapPin size={16} /> San Jose, CA
              </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="col-span-1 lg:col-span-2 space-y-12">
            {/* Bio Terminal */}
            <section>
              <h2 className="terminal-prompt text-2xl font-bold mb-4 inline-block">
                whoami
              </h2>
                ...
                <div className="pl-4 border-l border-border/50 ml-2">
                  <p className="mb-2">
                    ...
                    <span className="text-[#a7f3d0]">
                      "I make AI systems run reliably in production."
                    </span>
                    ,
                  </p>
                  <p className="mb-2">
                    ...
                    :{" "}
                    <span className="text-[#a7f3d0]">
                      "distributed systems + applied AI in one brain"
                    </span>
                    ,
                  </p>
                  <p className="mb-2">
                    ...
                    : [
                    <span className="text-[#a7f3d0]">"agentic workflows"</span>,{" "}
                    <span className="text-[#a7f3d0]">"GPU serving"</span>,{" "}
                    <span className="text-[#a7f3d0]">"LLM fine-tuning"</span>
                    ],
                  </p>
                  <p className="mb-0 text-[#9ca3af]">
                    // Reverse-engineering how deep learning scaling actually
                    works.
                  </p>
                </div>
                <p className="mt-4">{"}"};</p>
            ...
            <section>
              ...
              <Link
                href="/projects"
                className="inline-flex items-center gap-2 text-primary font-mono text-sm mt-4 hover:underline group"
              >
                View all projects{" "}
                <ArrowRight
                  size={14}
              ...
              <div className="glass p-6 rounded-lg border border-border flex flex-col md:flex-row items-center gap-6 justify-between">
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">
                    Interactive WebGL Space
                  </h3>
                  <p className="text-sm text-muted-foreground font-sans max-w-sm">
                    A lightweight React Three Fiber demonstration showcasing 3D
                    WebGL integration within Next.js contexts.
                  </p>
                </div>
                <Link href="/exhibition" className="shrink-0 w-full md:w-auto">
                  <button className="w-full px-6 py-3 bg-primary text-black font-bold font-mono rounded hover:bg-orange-400 transition-colors">
                    Enter Room
                  </button>
                </Link>
              </div>
              ...
              <ul className="space-y-6 relative before:content-[''] before:absolute before:left-[5px] before:top-2 before:bottom-2 before:w-[2px] before:bg-border">
                {recentNews.map((news, i) => (
                  <li key={i} className="text-sm relative pl-6">
                    ...
                    <span className="block text-primary font-mono mb-1">
                      {news.date}
                    </span>
